...
JumpServer 是一个开源的特权访问管理（PAM）工具，旨在通过网页浏览器为 DevOps 和 IT 团队提供按需和安全的 SSH、RDP、Kubernetes、数据库和远程应用程序端点访问。
...
JumpServer 是一个关键任务产品。请参考安装和部署的基本安全建议。如果您遇到任何安全相关问题，请直接联系我们：
...
依据 GNU 通用公共许可证第 3 版 (GPLv3)（“许可证”）授权；您不能在未遵守许可证的情况下使用此文件。您可以在以下网址获取许可证的副本

https://www.gnu.org/licenses/gpl-3.0.html

除非适用法律要求或书面同意，否则根据许可证分发的软件均为“按现状”提供，不附带任何形式的保证或条件，无论是明示或暗示。有关许可证下权限和限制的具体语言，请参见许可证。
