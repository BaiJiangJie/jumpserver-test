...
JumpServer é uma ferramenta de Gestão de Acesso Privilegiado (PAM) de código aberto que fornece às equipes de DevOps e TI acesso seguro e sob demanda a SSH, RDP, Kubernetes, bancos de dados e endpoints RemoteApp através de um navegador web.
...
JumpServer é composto por vários componentes-chave, que em conjunto formam o framework funcional do JumpServer, fornecendo aos usuários capacidades abrangentes para gerenciamento de operações e controle de segurança.
...
JumpServer é um produto crítico para missão. Por favor, consulte as Recomendações Básicas de Segurança para instalação e implantação. Se você encontrar qualquer problema relacionado à segurança, entre em contato conosco diretamente:
