...
[//]: # (Navegação de idioma)
**Português (Brasil)** · [中文(简体)](./readmes/README.zh-hans.md) · [中文(繁體)](./readmes/README.zh-hant.md) · [日本語](./readmes/README.ja.md) · [English](./readmes/README.en.md)
...
JumpServer é uma ferramenta de Gerenciamento de Acesso Privilegiado (PAM) de código aberto que fornece às equipes de DevOps e TI acesso seguro e sob demanda a SSH, RDP, Kubernetes, Banco de Dados e pontos finais de RemoteApp através de um navegador web.
...
Acesse o JumpServer no seu navegador em `http://seu-ip-do-jumpserver/`
...
JumpServer consiste em vários componentes-chave, que juntos formam a estrutura funcional do JumpServer, proporcionando aos usuários capacidades abrangentes para gerenciamento de operações e controle de segurança.
...
JumpServer é um produto de missão crítica. Consulte as Recomendações Básicas de Segurança para instalação e implantação. Se você encontrar qualquer problema relacionado à segurança, entre em contato diretamente conosco:
